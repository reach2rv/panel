...
// DisablePage 禁用页面路径
const DisablePage = "/opt/ornaverse/server/nginx/html/stop.html"
...
const DefaultConf = `# Auto-generated by OrnaVerse Panel. DO NOT EDIT MANUALLY!
include /opt/ornaverse/sites/default/config/shared/*.conf;
server {
    listen 80;
    server_name localhost;
    root /opt/ornaverse/sites/default/public;
    index index.html;
    # custom configs
    include /opt/ornaverse/sites/default/config/site/*.conf;
}
`
