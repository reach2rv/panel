...
// DisablePage 禁用页面路径
const DisablePage = "/opt/ornaverse/server/apache/htdocs/stop.html"

// SitesPath 网站目录
const SitesPath = "/opt/ornaverse/sites"
...
const DefaultVhostConf = `# Auto-generated by OrnaVerse Panel. DO NOT EDIT MANUALLY!
IncludeOptional /opt/ornaverse/sites/default/config/shared/*.conf
<VirtualHost *:80>
    ServerName localhost
    DocumentRoot /opt/ornaverse/sites/default/public
    DirectoryIndex index.html
    # custom configs
    IncludeOptional /opt/ornaverse/sites/default/config/site/*.conf
    <Directory /opt/ornaverse/sites/default/public>
